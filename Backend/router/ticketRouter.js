...
ticketRouter.put("/in-progress-ticket/:id", authMiddleware, ticketController.inProgresss)
ticketRouter.get("/get-ticket/:id", authMiddleware, ticketController.getTicketById)
